					...
					<div class="col-sm-8">
						<div class="blog-post blog-single-post page-content">
							<div class="single-post-title" style="border-bottom: 2px dotted #CCC; margin-bottom:15px;">
								<div style="float:left;"><h2>{lang:"visitors","app_visitors"}</h2></div>
                                
                                <div style="float:right; padding-bottom:5px;">
                                <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/visitors/","index.php?m=account_visitors"}" class="btn active"><i class="glyphicon glyphicon-eye-open"></i> {lang:"visitors","app_visitors"}</a>
                                </div>
...
position: relative;
                                ...
                                <div class="datainfo">
                                    ...
                                    <dt style="float:left;">{lang:"visitors","visit_time"}:</dt>
									<dd style="float:left; padding-left:7px;">{member_visit_date}</dd>
