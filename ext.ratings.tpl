<div class="ratingbox">
	...
	<!-- ELSE -->
		...
		<div class="progress" id="rating_{ext_rating_type}_progress{ext_rating_item_id}"></div>
	<!-- ENDIF -->
</div>
<script type="text/javascript" language="javascript">ratingstar_reset('{ext_rating_type}', {ext_rating_item_id}<!-- IF ext_rating_locked -->, 1<!-- ENDIF -->);</script>
