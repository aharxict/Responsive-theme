<div class="vt_prof clearfix">
    ...
    <div class="vt_image <!-- IF top.loggedin --> {vldthemes:a="onlinestatus",status=member_online} <!-- ENDIF -->">
        <a href="{top.virtual_path}{member_profile_link}">     
            ...
            <img class="img-full img-responsive ease 1" src="{top.virtual_pic_path}{member_media_path}{member_picture}" alt="" border="0" />
            <!--  <img class="img-full img-responsive ease 1" src="{vldthemes:a="thumbnail",path=member_media_path,filename=member_picture}" alt="" border="0" />-->
            <!-- ELSE -->
            <img class="img-full img-responsive ease 2" src="{vldthemes:a="blur",path=member_media_path,filename=member_picture}" alt="" border="0" />
            <!-- ENDIF -->
            <!-- ELSE -->
              <img class="img-full img-responsive ease 3"  src="{top.virtual_tpl_path}{session.template}/images/<?php echo vldThemes::avatar_obj($_obj);?>" alt="" border="0" />
            <!-- ENDIF -->
        </a>
