<!-- IF ext_members -->
<div style="position: relative; box-shadow: 1px 1px 5px 0px #CED4E0; border-radius: 3px; background: #FFF none repeat scroll 0% 0%; margin-top: 10px;  margin-bottom:7px;">
