		...
		<form name="form_filter" action="" method="post">
			<div class="fieldset">
				<dl class="fieldset">
					...
					<dd><select class="select" name="orderby" id="field_orderby">{dropdownlist:orderby_box,entries_orderby}</select></dd>
					<dt style="display:none2"><label for="field_direction">{lang:"core","order_direction"}</label></dt>
					<dd style="display:none2"><select class="select" name="direction" id="field_direction">{dropdownlist:direction_box,entries_direction}</select></dd>
