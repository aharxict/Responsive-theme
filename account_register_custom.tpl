        ...
        <div class="col-sm-9">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body ">
                    <div class="row">
                        <div class="col-sm-8" >
                            <form name="register" method="post" id="regwrapper2" class="form-horizontal clearfix" action="{virtual_path}account/register" onsubmit="return validateRequired() " enctype="multipart/form-data">
