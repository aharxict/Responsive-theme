					...
					<div class="col-sm-8">
						<div class="blog-post blog-single-post page-content">
							<div class="single-post-title" style="border-bottom: 2px dotted #CCC; margin-bottom:15px;">
								<div style="float:left;"><h2>{lang:"friends","opt_friends"}</h2></div>
                                
                                <div style="float:right; padding-bottom:5px;">
                                <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/friends/","index.php?m=account_friends"}" class="btn <!-- IF active_module == "account_friends" -->active<!-- ENDIF -->"><i class="glyphicon glyphicon-heart"></i> {lang:"friends","opt_friends"}</a>
                           
                           <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/friends/requests/","index.php?m=account_friends&p=requests"}" class="btn"><i class="glyphicon glyphicon-info-sign"></i> {lang:"friends","app_friends_requests"}<!-- IF session.new_friends --> ({session.new_friends})<!-- ENDIF --></a>
                           
                           <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/friends/online/","index.php?m=account_friends&p=online"}" class="btn <!-- IF active_module == "account_friends_online" -->active<!-- ENDIF -->"><i class="glyphicon glyphicon-globe"></i> {lang:"friends","opt_friends_online"}</a>
                                </div>
	...
	<!-- IF total_pages > "1" -->
		<div class="footer_wrap">
			<div class="footer">
				<p>{pages_info}</p>
				<!-- IF previous_page != "0" -->
					<a href="{virtual_path}{previous_page_link}">&laquo; {lang:"friends","previous_page"}</a>
				<!-- ENDIF -->
				<!-- IF next_page != "0" -->
					<a href="{virtual_path}{next_page_link}">{lang:"friends","next_page"} &raquo;</a>
				<!-- ENDIF -->
				<div class="clear"></div>
			</div>
		</div>
