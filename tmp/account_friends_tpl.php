					...
					<div class="col-sm-8">
						<div class="blog-post blog-single-post page-content">
							<div class="single-post-title" style="border-bottom: 2px dotted #CCC; margin-bottom:15px;">
								<div style="float:left;"><h2><?php echo vldext_lang("friends","opt_friends"); ?></h2></div>
                                
                                <div style="float:right; padding-bottom:5px;">
                                <a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo vldext_ifelse($PREFS->conf['fancy_urls'],"1","account/friends/","index.php?m=account_friends"); ?>" class="btn <?php if ( $this->objval($_obj,'active_module')  == "account_friends") { ?>active<?php } ?>"><i class="glyphicon glyphicon-heart"></i> <?php echo vldext_lang("friends","opt_friends"); ?></a>
                           
                           <a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo vldext_ifelse($PREFS->conf['fancy_urls'],"1","account/friends/requests/","index.php?m=account_friends&p=requests"); ?>" class="btn"><i class="glyphicon glyphicon-info-sign"></i> <?php echo vldext_lang("friends","app_friends_requests"); ?><?php if ( @$SESSION->conf['new_friends'] ) { ?> (<?php echo isset($SESSION->conf['new_friends']) ? $SESSION->conf['new_friends'] : "&#123;new_friends&#125;"; ?>)<?php } ?></a>
                           
                           <a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo vldext_ifelse($PREFS->conf['fancy_urls'],"1","account/friends/online/","index.php?m=account_friends&p=online"); ?>" class="btn <?php if ( $this->objval($_obj,'active_module')  == "account_friends_online") { ?>active<?php } ?>"><i class="glyphicon glyphicon-globe"></i> <?php echo vldext_lang("friends","opt_friends_online"); ?></a>
                                </div>
		...
		<div class="footer_wrap">
			<div class="footer">
				...
				<?php if ( $this->objval($_obj,'previous_page')  != "0") { ?>
					<a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo isset($_obj['previous_page_link']) ? $_obj['previous_page_link'] : "&#123;previous_page_link&#125;"; ?>">&laquo; <?php echo vldext_lang("friends","previous_page"); ?></a>
				<?php } ?>
				<?php if ( $this->objval($_obj,'next_page')  != "0") { ?>
					<a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo isset($_obj['next_page_link']) ? $_obj['next_page_link'] : "&#123;next_page_link&#125;"; ?>"><?php echo vldext_lang("friends","next_page"); ?> &raquo;</a>
				<?php } ?>
				<div class="clear"></div>
			</div>
		</div>
