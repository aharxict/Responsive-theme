					...
					<div class="col-sm-8">
						<div class="blog-post blog-single-post page-content">
							<div class="single-post-title" style="border-bottom: 2px dotted #CCC; margin-bottom:15px;">
                                ...
                                <a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo vldext_ifelse($PREFS->conf['fancy_urls'],"1","account/events/","index.php?m=account_events"); ?>" class="btn active"><i class="glyphicon glyphicon-calendar"></i> <?php echo vldext_lang("events","opt_events"); ?></a>
                                <a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo vldext_ifelse($PREFS->conf['fancy_urls'],"1","account/events/joined/","index.php?m=account_events&p=joined"); ?>" class="btn"><i class="glyphicon glyphicon-calendar"></i> <?php echo vldext_lang("events","opt_joinedevents"); ?></a>
                                
                                <a href="<?php echo isset($_obj['virtual_path']) ? $_obj['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo vldext_ifelse($PREFS->conf['fancy_urls'],"1","account/events/add/","index.php?m=account_events&p=add"); ?>" class="btn"><i class="glyphicon glyphicon-calendar"></i> <?php echo vldext_lang("events","opt_addevent"); ?></a>
				...
				<div class="dataitem <?php echo vldext_ifelse($_obj['rownum'],"1","odd","even"); ?> <?php echo vldext_ifelse($_obj['rowlast'],"1","dataitemlast",""); ?>">
					<table class="plain">
						<tr>
							<td valign="top">
								<div class="image">
									<?php if ( $this->objval($_obj,'event_picture_preview') ) { ?>
										<a href="<?php echo isset($_stack[0]['virtual_path']) ? $_stack[0]['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo isset($_obj['event_edit_link']) ? $_obj['event_edit_link'] : "&#123;event_edit_link&#125;"; ?>"><img src="<?php echo isset($_stack[0]['virtual_pic_path']) ? $_stack[0]['virtual_pic_path'] : "&#123;virtual_pic_path&#125;"; ?><?php echo isset($SESSION->conf['media_path']) ? $SESSION->conf['media_path'] : "&#123;media_path&#125;"; ?><?php echo isset($_obj['event_picture_preview']) ? $_obj['event_picture_preview'] : "&#123;event_picture_preview&#125;"; ?>" alt="" border="0" style="padding-right:10px;" /><br /></a>
									<?php } else { ?>
							...
							<td class="data" valign="top">
								<div class="datainfo" style="padding-top:5px;width:400px !important;overflow:inherit;word-wrap: break-word;">
									<h2 class="inner" style="font-size:18px;"><a href="<?php echo isset($_stack[0]['virtual_path']) ? $_stack[0]['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo isset($_obj['event_edit_link']) ? $_obj['event_edit_link'] : "&#123;event_edit_link&#125;"; ?>"><?php echo isset($_obj['event_name']) ? $_obj['event_name'] : "&#123;event_name&#125;"; ?></a></h2>
									<dl class="datainfo">
							...
							<td>
								<div class="actions">
									<ul class="actions" style="list-style-type:none;">
										<li class="guests"><span class="glyphicon glyphicon-user" style="padding-right:8px;"></span> <a href="<?php echo isset($_stack[0]['virtual_path']) ? $_stack[0]['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo isset($_obj['event_guests_link']) ? $_obj['event_guests_link'] : "&#123;event_guests_link&#125;"; ?>"><?php echo isset($_obj['event_total_guests']) ? $_obj['event_total_guests'] : "&#123;event_total_guests&#125;"; ?> <?php if ( $this->objval($_obj,'event_max_guests') ) { ?>/ <?php echo isset($_obj['event_max_guests']) ? $_obj['event_max_guests'] : "&#123;event_max_guests&#125;"; ?><?php } ?> <?php echo vldext_lang("events","total_guests"); ?></a></li>
										...
										<?php } ?>
										<?php if ( @$PREFS->conf['enable_event_pictures']  &&  @$SESSION->conf['can_view_own_events_pictures'] ) { ?>
										...
										<?php } ?>
										<?php if ( @$SESSION->conf['can_edit_own_events'] ) { ?>
											<li class="edit"><span class="glyphicon glyphicon-edit" style="padding-right:8px;"></span> <a href="<?php echo isset($_stack[0]['virtual_path']) ? $_stack[0]['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo isset($_obj['event_edit_link']) ? $_obj['event_edit_link'] : "&#123;event_edit_link&#125;"; ?>"><?php echo vldext_lang("events","edit"); ?></a></li>
										<?php } ?>
										<?php if ( @$SESSION->conf['can_delete_own_events'] ) { ?>
											<li class="remove"><span class="glyphicon glyphicon-remove-circle" style="padding-right:8px;"></span> <a href="#" onclick="javascript:confirmLink('<?php echo vldext_lang("events","delete?"); ?>', '<?php echo isset($_stack[0]['virtual_path']) ? $_stack[0]['virtual_path'] : "&#123;virtual_path&#125;"; ?><?php echo isset($_obj['event_delete_link']) ? $_obj['event_delete_link'] : "&#123;event_delete_link&#125;"; ?>')" title="<?php echo vldext_lang("events","delete"); ?>"><?php echo vldext_lang("events","delete"); ?></a></li>
										<?php } ?>
									</ul>
									<div class="clear"></div>
								</div>
