					...
					<div class="col-sm-8">
						<div class="blog-post blog-single-post page-content">
							<div class="single-post-title" style="border-bottom: 2px dotted #CCC; margin-bottom:15px;">
								<div style="float:left;"><h2><!-- IF page_online -->{lang:"favorites","app_favorites_online"}<!-- ELSE -->{lang:"favorites","app_favorites"}<!-- ENDIF --></h2></div>
                                
                                <div style="float:right; padding-bottom:5px;">
                                <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/favorites/","index.php?m=account_favorites"}" class="btn <!-- IF active_module == "account_favorites" -->active<!-- ENDIF -->"><i class="glyphicon glyphicon-star"></i> {lang:"favorites","opt_favorites"}</a>
                           
                           <!-- IF settings.enable_fans AND session.can_view_own_fans -->
                           <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/favorites/fans/","index.php?m=account_favorites&p=fans"}" class="btn"><i class="glyphicon glyphicon-info-sign"></i> {lang:"favorites","opt_fans"}</a>
                           <!-- ENDIF -->
                           
                           <!-- IF show_online_tab -->
                           <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/favorites/online/","index.php?m=account_favorites&p=online"}" class="btn <!-- IF active_module == "account_favorites_online" -->active<!-- ENDIF -->"><i class="glyphicon glyphicon-globe"></i> {lang:"favorites","opt_favorites_online"}</a>
                           <!-- ENDIF -->
                                </div>
		                    ...
		                    <div style="float:right;">
								<div class="actions">
									<ul class="actions" style="list-style:none inside; padding-left:0; margin-left:0;">
										...
										<!-- IF session.can_delete_own_favorites -->
											<li class="remove"><a href="#" onclick="javascript:confirmLink('{lang:"favorites","delete?"}', '{top.virtual_path}{member_delete_link}')" title="{lang:"favorites","delete"}"><span class="glyphicon glyphicon-remove" style="padding-right:8px;"></span>{lang:"favorites","delete"}</a></li>
										<!-- ENDIF -->
									</ul>
									<div class="clear"></div>
								</div>
