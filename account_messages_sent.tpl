					...
					<div class="col-sm-8">
						<div class="blog-post blog-single-post page-content">
							<div class="single-post-title" style="border-bottom: 2px dotted #CCC; margin-bottom:15px;">
								<div style="float:left;"><h2>{lang:"messages","app_sent"}</h2></div>
                           ...
                           <a href="{virtual_path}{ifelse:settings.fancy_urls,"1","account/messages/sent/","index.php?m=account_messages&p=sent"}" class="btn active"><i class="glyphicon glyphicon-send"></i> {lang:"messages","opt_sent"} ({session.totalsmessages})</a>
                                </div>
        ...
        <div class="form" style="margin-top:15px;">
			...
			<table class="pmbox" style="width:100%;">
				...
				<!-- BEGIN profile_messages -->
					<tr class="row {ifelse:rownum,"1","odd","even"} {ifelse:rowlast,"1","dataitemlast",""}" style="border-bottom: 1px dotted #CCC;">
						...
						<td class="subject" valign="top" style="padding-top:10px; padding-bottom:10px;">
							Rubrik: <a href="{top.virtual_path}{message_link}">{trim:message_subject,90}</a>
							<div class="preview">Meddelande: {trim:message_body,90}</div>
                            <div class="date" style="font-size:12px;">{message_date} <!-- IF message_new -->({lang:"messages","status_unread"})<!-- ELSE -->({lang:"messages","status_read"})<!-- ENDIF --></div>
						</td>
					</tr>
